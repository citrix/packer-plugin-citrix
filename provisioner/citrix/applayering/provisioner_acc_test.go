...
// Run with: PACKER_ACC=1 go test -count 1 -v ./provisioner/applayering/provisioner_acc_test.go  -timeout=120m
func TestAccapplayeringProvisioner(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "applayering_provisioner_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Type:     "applayering-my-provisioner",
